...
export default function Section2({ style, isDesktop }) {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="p-3 text-2xl sm:text-4xl md:text-5xl font-extrabold mb-10 text-center bg-linear-to-r from-cyan-400 via-blue-400 to-cyan-300 bg-clip-text text-transparent drop-shadow-[0_0_24px_rgba(34,211,238,0.35)]">
